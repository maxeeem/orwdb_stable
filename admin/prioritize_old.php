...
<link rel="stylesheet" type="text/css" href="../styling/css.css">
...
<?php include("../styling/header.html"); ?>
</head>
<body>
<div id="body-margin">
<?php
...
function showCategories($array) {
	...
	$select = "<select id='categories' onchange='showFilters($jsfilters)'><option value='' selected disabled>Select Category</option>";
